...
<body class="font-sans antialiased">
    <div class="flex login-container">
        ...
        <div class="relative flex items-center justify-center w-full p-8 bg-white lg:w-1/2">
            <!-- Background Change Button -->
            <button id="backgroundToggle"
                class="absolute p-2 transition-all duration-300 bg-gray-100 rounded-full top-4 right-4 hover:bg-gray-200">
            ...
            <div class="w-full max-w-md animate-slideInRight">
                ...
                <div class="mb-8 text-center">
                    <p class="mb-2 text-sm text-gray-500">LET'S GET YOU STARTED</p>
                ...
                <form method="POST" action="{{ route('login') }}" class="space-y-6">
                    ...
                    <div class="flex items-center justify-between">
                        ...
                        @if (Route::has('password.request'))
                            <a class="text-sm text-indigo-600 transition-colors duration-300 hover:text-indigo-500"
