...
<body class="font-sans antialiased">
    <div class="flex register-container">
        <!-- Left Side - Branding -->
        <div class="relative z-10 flex-col items-start justify-center hidden p-12 text-white lg:flex lg:w-1/2">
            <div class="animate-fadeInUp">
                <!-- Logo -->
                <div class="flex items-center mb-8">
                    <div class="flex items-center justify-center w-12 h-12 mr-4 overflow-hidden bg-white rounded-lg">
                        <img src="{{ asset('images/binmas.png') }}" alt="Logo" class="object-contain w-8 h-8">
                    </div>
                ...
                <div class="mb-8 space-y-4">
                    <div class="flex items-center">
                        <div class="w-2 h-2 mr-3 bg-white rounded-full"></div>
        ...
        <div class="relative flex items-center justify-center w-full p-8 overflow-y-auto bg-white lg:w-1/2">
            <!-- Background Change Button -->
            <button id="backgroundToggle"
                class="absolute z-10 p-2 transition-all duration-300 bg-gray-100 rounded-full top-4 right-4 hover:bg-gray-200">
            ...
            <div class="w-full max-w-md py-8 animate-slideInRight">
                <!-- Header -->
                ...
                <form method="POST" action="{{ route('register') }}" class="space-y-5">
                    ...
                    <div>
                        <label for="email"
                            class="block mb-2 text-sm font-medium text-gray-700">{{ __('Email') }}</label>
                        <input id="email"
                            class="w-full px-4 py-3 transition-all duration-300 border border-gray-300 rounded-lg form-input focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500"
                    ...
                    <div>
                        <label for="no_hp"
                            class="block mb-2 text-sm font-medium text-gray-700">{{ __('No. Telp / Whatsapp') }}</label>
                        <input id="no_hp"
                            class="w-full px-4 py-3 transition-all duration-300 border border-gray-300 rounded-lg form-input focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500"
                    ...
                    <div>
                        <label for="password_confirmation"
                            class="block mb-2 text-sm font-medium text-gray-700">{{ __('Confirm Password') }}</label>
                        <div class="relative">
                    ...
                    <!-- Register Button -->
                    <button type="submit"
                        class="w-full px-4 py-3 font-medium text-white transition-all duration-300 rounded-lg btn-primary hover:opacity-90">
                        {{ __('Buat Akun') }}
                    </button>
                    ...
                    <div class="mt-6 text-center">
                        <p class="text-sm text-gray-600">
                            ...
                            <a href="{{ route('login') }}"
                                class="font-medium text-indigo-600 transition-colors duration-300 hover:text-indigo-500">
                                SIGN IN
                            </a>
                        </p>
                    </div>
