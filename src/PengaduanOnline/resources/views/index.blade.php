...
<body class="homepage">
    ...
    <div class="search-popup">
        <div class="search-popup-container">
            ...
            <form role="search" method="get" class="form-group" action="">
                <input type="search" id="search-form" class="border-0 form-control border-bottom"
                    placeholder="Type and press enter" value="" name="s" />
                <button type="submit" class="bg-white border-0 search-submit position-absolute"
    ...
    <section id="billboard" class="py-5 bg-light">
        <div class="container">
            ...
            <div class="row">
                <div class="py-4 swiper main-swiper" data-aos="fade-up" data-aos-delay="600">
    ...
    <section class="py-5 features">
        <div class="container">
            <div class="row">
                <div class="text-center col-md-3" data-aos="fade-in" data-aos-delay="0">
                    <div class="py-5">
                        <svg width="38" height="38" viewBox="0 0 24 24">
                            <use xlink:href="#calendar"></use>
                        </svg>
                        <h4 class="my-3 element-title text-capitalize">Book An Appointment</h4>
                        <p>At imperdiet dui accumsan sit amet nulla risus est ultricies quis.</p>
                    </div>
                </div>
                <div class="text-center col-md-3" data-aos="fade-in" data-aos-delay="300">
                    <div class="py-5">
                        <svg width="38" height="38" viewBox="0 0 24 24">
                            <use xlink:href="#shopping-bag"></use>
                        </svg>
                        <h4 class="my-3 element-title text-capitalize">Pick up in store</h4>
                        <p>At imperdiet dui accumsan sit amet nulla risus est ultricies quis.</p>
                    </div>
                </div>
                <div class="text-center col-md-3" data-aos="fade-in" data-aos-delay="600">
                    <div class="py-5">
                        <svg width="38" height="38" viewBox="0 0 24 24">
                            <use xlink:href="#gift"></use>
                        </svg>
                        <h4 class="my-3 element-title text-capitalize">Special packaging</h4>
                        <p>At imperdiet dui accumsan sit amet nulla risus est ultricies quis.</p>
                    </div>
                </div>
                <div class="text-center col-md-3" data-aos="fade-in" data-aos-delay="900">
                    <div class="py-5">
                        <svg width="38" height="38" viewBox="0 0 24 24">
                            <use xlink:href="#arrow-cycle"></use>
                        </svg>
                        <h4 class="my-3 element-title text-capitalize">free global returns</h4>
                        <p>At imperdiet dui accumsan sit amet nulla risus est ultricies quis.</p>
                    </div>
                </div>
            </div>
    ...
    <section id="new-arrival" class="py-5 overflow-hidden new-arrival product-carousel position-relative">
        <div class="container">
            <div class="flex-wrap mt-5 mb-3 d-flex justify-content-between align-items-center">
                        ...
                        <div class="product-item image-zoom-effect link-effect">
                            <div class="image-holder position-relative">
                                ...
                                <div class="product-content">
                                    <h5 class="mt-3 element-title text-uppercase fs-5">
                    ...
                    <div class="swiper-slide">
                        <div class="product-item image-zoom-effect link-effect">
                            <div class="image-holder position-relative">
                                ...
                                <div class="product-content">
                                    <h5 class="mt-3 text-uppercase fs-5">
    ...
    <section class="py-5 collection bg-light position-relative">
        <div class="container">
            <div class="row">
                <div class="title-xlarge text-uppercase txt-fx domino">Collection</div>
                <div class="flex-wrap my-5 collection-item d-flex">
                    <div class="col-md-6 column-container">
                        <div class="image-holder">
                            <img src="images/single-image-2.jpg" alt="collection" class="product-image img-fluid">
                        </div>
                    </div>
                    <div class="bg-white col-md-6 column-container">
                        <div class="p-5 m-0 collection-content m-md-5">
                            ...
                            <a href="#" class="mt-3 btn btn-dark text-uppercase">Shop Collection</a>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <section id="best-sellers" class="py-5 overflow-hidden best-sellers product-carousel position-relative">
        <div class="container">
            <div class="flex-wrap mt-5 mb-3 d-flex justify-content-between align-items-center">
    ...
    <section class="py-5 overflow-hidden video">
    ...
    <section class="py-5 testimonials bg-light">
        <div class="mt-5 text-center section-header">
            <h3 class="section-title">WE LOVE GOOD COMPLIMENT</h3>
        </div>
        <div class="my-5 overflow-hidden swiper testimonial-swiper">
            <div class="swiper-wrapper d-flex">
                <div class="swiper-slide">
        ...
        <div class="mb-5 testimonial-swiper-pagination d-flex justify-content-center"></div>
    </section>

    <section id="related-products" class="py-5 overflow-hidden related-products product-carousel position-relative">
        <div class="container">
            <div class="flex-wrap mt-5 mb-3 d-flex justify-content-between align-items-center">
            ...
            <div class="row">
                <div class="col-md-4">
                    <article class="post-item">
                        ...
                        <div class="flex-wrap gap-2 my-3 post-content d-flex">
    ...
    <section class="instagram position-relative">
        <div class="bottom-0 d-flex justify-content-center w-100 position-absolute z-1">
            <a href="https://www.instagram.com/templatesjungle/" class="px-5 btn btn-dark">Follow us on Instagram</a>
        </div>
        <div class="row g-0">
