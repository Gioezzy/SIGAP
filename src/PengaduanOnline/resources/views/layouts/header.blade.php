<nav class="p-3 navbar navbar-expand-lg bg-light text-uppercase fs-6 border-bottom align-items-center">
    <div class="container-fluid">
        <div class="row justify-content-between align-items-center w-100">

            <div class="col-auto">
                <a class="text-white navbar-brand" href="{{route('index')}}">
            ...
            <div class="col-auto">
                ...
                <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasNavbar"
                    ...
                    <div class="offcanvas-body">
                        <ul class="gap-1 navbar-nav justify-content-end flex-grow-1 gap-md-5 pe-3">
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <ul class="dropdown-menu list-unstyled" aria-labelledby="dropdownPages">
                                    ...
                                    <li>
                                        <a href="index.html" class="dropdown-item item-anchor">Login</a>
                                    </li>
                                </ul>
                            </li>
                            <li class="nav-item">
                ...
                <ul class="m-0 list-unstyled d-flex">
                    @if (Auth::check())
                        {{-- <li class="d-none d-lg-block">
                            <a href="{{route('profile.edit')}}" class="mx-3 text-uppercase">Profile
                            </a>
                        </li> --}}
                    ...
                    @else
                        <li class="d-none d-lg-block">
                            <a href="{{route('login')}}" class="mx-3 text-uppercase">Login
                            </a>
                        </li>
                        <li class="d-none d-lg-block">
                            <a href="{{route('register')}}" class="mx-3 text-uppercase">Register
                            </a>
                        </li>
                    @endif
                </ul>
