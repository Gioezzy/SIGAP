        ...
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            <div class="mb-12 animate-fade-in-up animation-delay-300 text-center">
                ...
                <p class="mt-4 text-lg text-gray-600 dark:text-gray-300 max-w-2xl mx-auto">
                    Pantau perkembangan dan tanggapan terkini dari petugas untuk setiap laporan keramaian yang telah Anda ajukan
                </p>
            </div>
                        ...
                        <div class="px-8 py-6">
                            <div class="flex items-center justify-between">
                                <h3 class="text-xl font-bold text-gray-800 dark:text-gray-200 flex items-center space-x-3">
                                    ...
                                    <span>Daftar Tanggapan Keramaian</span>
                                </h3>
                                    ...
                                    <tr class="group hover:bg-gradient-to-r hover:from-indigo-50/80 hover:via-purple-50/80 hover:to-pink-50/80 dark:hover:from-indigo-900/30 dark:hover:via-purple-900/30 dark:hover:to-pink-900/30 transition-all duration-700 transform hover:scale-[1.01] hover:shadow-lg animate-table-row"
                                        ...
                                        <td class="px-8 py-6 font-semibold text-gray-900 dark:text-gray-100 group-hover:text-indigo-600 dark:group-hover:text-indigo-400 transition-colors duration-300">
                                            <div class="flex items-center space-x-3">
                                                ...
                                                <span class="line-clamp-2">{{ $tanggapan->keramaian->nama_acara ?? '-' }}</span>
                                            </div>
                                        </td>
                                        <td class="px-8 py-6">
                                            <div class="space-y-2">
                                                <div class="flex items-center space-x-2">
                                                    ...
                                                    <span class="text-sm text-gray-700 dark:text-gray-300">{{ $tanggapan->keramaian->lokasi_acara ?? '-' }}</span>
                                                </div>
                                                <div class="flex items-center space-x-2">
                                                    <svg class="w-4 h-4 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                    ...
                                                    <span class="text-sm text-gray-700 dark:text-gray-300">
                                                        {{ \Carbon\Carbon::parse($tanggapan->keramaian->tanggal_acara)->translatedFormat('d M Y') ?? '-' }}
                                                    </span>
                                                </div>
                                                <div class="flex items-center space-x-2">
                                                    <svg class="w-4 h-4 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                    ...
                                                    <span class="text-sm text-gray-700 dark:text-gray-300">{{ $tanggapan->keramaian->waktu_acara ?? '-' }}</span>
                                                </div>
                                            </div>
                                        </td>
                                        ...
                                        <td class="px-8 py-6">
                                            @php
                                                $status = strtolower($tanggapan->keramaian->status ?? 'menunggu');
                                                $statusConfig = [
                                                    'disetujui' => [
                                                    ...
                                                    'menunggu' => [
                                                        'class' => 'bg-gradient-to-r from-orange-100 to-yellow-100 text-yellow-800 dark:from-orange-900/60 dark:to-yellow-900/60 dark:text-yellow-200 border-yellow-200/50 dark:border-yellow-800/50',
                                        ...
                                        <td colspan="5" class="px-8 py-24 text-center">
                                            <div class="flex flex-col items-center space-y-4">
                                                ...
                                                <div class="text-center">
                                                    <h3 class="text-2xl font-bold text-gray-600 dark:text-gray-300 mb-2">Belum Ada Tanggapan Keramaian</h3>
                                                    <p class="text-gray-500 dark:text-gray-400 max-w-md mx-auto">
                                                        Tanggapan dari petugas akan tampil di sini setelah tersedia. Kami akan memproses laporan keramaian Anda dengan segera.
                                                    </p>
                                                </div>
                                            </div>
                                        </td>
